                        ...
                        <div class="row align-items-center slider-animated-1">
                            ...
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated slider-1-1" src=" {{ asset('web/images/slider-1.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single-hero-slider single-animation-wrap">
                    <div class="container">
                        <div class="row align-items-center slider-animated-1">
                            ...
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated slider-1-2" src="{{ asset('web/images/slider-2.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single-hero-slider single-animation-wrap">
                    <div class="container">
                        <div class="row align-items-center slider-animated-1">
                            ...
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated slider-1-3" src="{{ asset('web/images/slider-3.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
