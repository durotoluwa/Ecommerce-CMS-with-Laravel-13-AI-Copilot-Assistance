...
<main class="main">
          	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">     {{ isset($category) ? $category->name : (isset($brand) ? $brand->name : '') }}</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
                ...
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Shop</a></li>
                            <li class="breadcrumb-item"><a href="#">{{ isset($category) ? $category->name : (isset($brand) ? $brand->name : '') }}</a></li>
...
@include('product-category.product_sidebar')
...
function filterProducts(url = null) {
 ...
 fetch("{{ route('category.filter', ['id' => $category->id]) }}", {
