            ...
            <tr>
                <td style="width:80px; text-align:center;">
                    @if($category->thumbnail)
                        <img src="{{ asset($category->thumbnail) }}" alt="{{ $category->name }}" style="max-width:60px; max-height:60px;">
                    @else
    ...
    <a href="javascript:void(0)" 
       ...
       data-id="{{ $category->id }}">
        ...
        @endif
                ...
                <td>
                    <a href="{{ route('admin.product_categories.edit', $category) }}" class="btn btn-sm btn-warning">Edit</a>
                    <form action="{{ route('admin.product_categories.destroy', $category) }}" method="POST" style="display:inline;">
                        @csrf @method('DELETE')
    ...
    <a href="javascript:void(0)" 
       ...
       data-id="{{ $category->id }}">
        ...
        @endif
                    ...
                    <td>
                        <a href="{{ route('admin.product_categories.edit', $child) }}" class="btn btn-sm btn-warning">Edit</a>
                        <form action="{{ route('admin.product_categories.destroy', $child) }}" method="POST" style="display:inline;">
                            @csrf @method('DELETE')
                            <button type="submit" class="btn btn-sm btn-danger"
                                    onclick="return confirm('Are you sure you want to delete this category?')">
                                Delete
