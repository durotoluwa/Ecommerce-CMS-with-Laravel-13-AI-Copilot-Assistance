 ...
 <div class="page-header">
						<div class="add-item d-flex">
							<div class="page-title">
								<h4 class="fw-bold">Homapage Testimony Section</h4>
								<h6>Testimony Section</h6>
							</div>
						</div>
...
<form action="{{ route('testimonysection.update', $section->id) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="testimony_heading" value="{{ old('testimony_heading', $section->testimony_heading) }}">
            </div>
        </div>
    ...
    <div class="mb-3">
        ...
        <select class="form-control" name="testimony_autoplay">
            <option value="1" {{ old('testimony_autoplay', $section->autoplay) == true ? 'selected' : '' }}>true</option>
            <option value="0" {{ old('testimony_autoplay', $section->autoplay) == false ? 'selected' : '' }}>false</option>
        </select>
    </div>
</div>
        ...
        <div class="col-md-4">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="testimony_autoplaytimeout" value="{{ old('testimony_autoplaytimeout', $section->testimony_autoplaytimeout) }}" placeholder="Enter Autoplay Timeout">
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="testimony_responsive992" value="{{ old('testimony_responsive992', $section->testimony_responsive992) }}">
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="testimony_responsive576" value="{{ old('testimony_responsive576', $section->testimony_responsive576) }}">
            </div>
        </div>

        <div class="col-md-4">
            <div class="mb-3 form-check">
                <input type="checkbox" name="testimony_status" value="1" class="form-check-input" {{ $section->testimony_status ? 'checked' : '' }}>
