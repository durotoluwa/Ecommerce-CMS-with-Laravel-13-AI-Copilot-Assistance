 ...
 <div class="page-header">
						<div class="add-item d-flex">
							<div class="page-title">
								<h4 class="fw-bold">Header Top</h4>
								<h6>Header Top  Section</h6>
							</div>
						</div>
...
<form action="{{ route('header_top.update', $section->id) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="col-md-4">
    <div class="mb-3">
      <label class="form-label">Header BG Colour</label>
      <input type="color" class="complex-colorpicker form-control" name="header_bg_color" value="{{ $section->header_bg_color }}">
  </div></div><!--==== end of col ======---->
    ...
    <div class="mb-3">
      ...
      <input type="color" class="complex-colorpicker form-control" name="header_text_color" value="{{ $section->header_text_color }}">
  </div></div><!--==== end of col ======---->
...
<input type="number" class="form-control" name="header_font_size" value="{{ $section->header_font_size }}">
        ...
        <div class="col-md-12">
            <div class="mb-3 form-check">
                <input type="checkbox" name="header_status" value="1" class="form-check-input" {{ $section->header_status ? 'checked' : '' }}>
