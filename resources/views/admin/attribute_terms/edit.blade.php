...
@endif    
<form action="{{ route('admin.attribute_terms.update', [$attribute->id, $term->id]) }}" method="POST">
    @csrf
    @method('PUT')
      <div class="col-md-12">
       <div class="mb-3">
    <label class="form-label">Name</label>
    <input class="form-control" type="text" name="name" value="{{ old('name', $term->name) }}" required>
    ...
    <input class="form-control" type="text" name="slug" value="{{ old('slug', $term->slug) }}"  >
