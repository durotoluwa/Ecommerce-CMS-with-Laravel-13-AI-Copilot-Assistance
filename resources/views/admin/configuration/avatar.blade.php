...
<div class="content">
 ...
 <div class="page-header">
						<div class="add-item d-flex">
							<div class="page-title">
								<h4 class="fw-bold">Avatar Image</h4>
								<h6>Manage your Avatar Image </h6>
							</div>
						</div>
 ...
 <form action="{{ route('updateAvatar') }}" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="id" value="{{ $avatarconfig->id }}">
    
        <div class="mb-3">
            <label class="form-label">Avatar Image</label>
    
            <div class="image-frame2" id="imagePreview" style="margin-bottom: 30px;">
                @if ($avatarconfig->error_page)
                <img src="{{ asset($avatarconfig->default_avatar) }}" alt="Current Error Page" id="previewImage">
            @else
                <span id="placeholderText">No image selected</span>
            @endif
            </div>
        
            <input class="form-control" name="default_avatar" type="file" id="imageInput" accept="image/*">
        </div>
