 ...
 <div class="page-header">
						<div class="add-item d-flex">
							<div class="page-title">
								<h4 class="fw-bold">All Banner Slider</h4>
...
<div class="table-responsive product-list">
    <table class="table datanew">
        ...
        <tr>
            <td>{{ $index + 1 }}</td>
            <td>
                <img src="{{ asset($slider->slider_image) }}" alt="Banner Image" width="120">
            </td>
            <td>
                {{-- Combine heading1 and heading2 for display --}}
                <strong>{!! $slider->heading1 !!}</strong><br>
                <small>{!! $slider->heading2 !!}</small>
            </td>
       
            <td>
                <a href="{{ route('banner_sliders.edit', $slider->id) }}" class="btn btn-sm btn-warning">Edit</a>
                <form action="{{ route('banner_sliders.destroy', $slider->id) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
