 ...
 <div class="page-header">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card">
								<div class="card-body">
<form action="{{ route('banner_sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="image-frame2" id="imagePreview" style="margin-bottom: 30px;">
                            <img src="{{ asset($slider->slider_image) }}" alt="Slider Image" style="width: 100%; height: auto; display: block;">
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input name="heading1" type="text" class="form-control" value="{{ old('heading1', $slider->heading1) }}">
                    </div>

                    <div class="mb-3">
                        <label>Heading H1</label>
                        <input name="heading2" type="text" class="form-control" value="{{ old('heading2', $slider->heading2) }}">
                    </div>

                    <div class="mb-3">
                        <label>Button Title</label>
                        <input name="button_title" type="text" class="form-control" value="{{ old('button_title', $slider->button_title) }}">
                    </div>

                    <div class="mb-3">
                        <label>Button Link</label>
                        <input name="button_link" type="text" class="form-control" value="{{ old('button_link', $slider->button_link) }}">
                    </div>
        ...
        <div class="col-xl-5">
            <button type="submit" class="btn btn-sm btn-primary mb-4 open">Update Slide</button>
        </div>
    </div><!-- Row -->
</form>
