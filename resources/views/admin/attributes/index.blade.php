...
<form action="{{ route('admin.attributes.store') }}" method="POST">
 ...
 <div class="col-md-12">
    ...
    <button type="submit" class="btn btn-sm btn-primary mb-4 open">Add attribute</button>
</form>
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach($attribute->terms as $term)
                                <span style="margin-right:5px;">{{ $term->name }}</span>
                            @endforeach<br><br>
                            <a href="{{ route('admin.attribute_terms.index', $attribute->id) }}" class="btn btn-sm btn-info">
                                Configure Terms
                            </a>
                        </td>
                        <td>
