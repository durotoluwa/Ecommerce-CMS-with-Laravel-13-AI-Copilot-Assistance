 ...
 <div class="page-header">
						<div class="add-item d-flex">
							<div class="page-title">
								<h4 class="fw-bold">Menu settings</h4>
								<h6>Manage your Menu Items </h6>
							</div>
						</div>
...
<script src="{{asset('admin/assets/js/global.min.js')}}"></script>
...
<script src="{{asset('admin/assets/js/jquery.mjs.nestedSortable.js')}}"></script>
<script>
$(function() {
