		...
		<div class="page-wrapper">
			<div class="content">
				...
				<div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-2">
					<div class="mb-3">
						<h1 class="mb-1">Welcome, {{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</h1>
						<p class="fw-medium">You have <span class="text-primary fw-bold">{{ $todayOrdersCount }}</span> Orders, Today</p>
					</div>
					<!----
							...
							<div class="card-body d-flex align-items-center">
								...
								<div class="ms-2">
									...
									<div class="d-inline-flex align-items-center flex-wrap gap-2">
										<h4 class="text-white">{{ $displayCurrency->symbol }}{{ number_format($totalsale, 2) }}</h4>
					...
					<div class="col-xl-3 col-sm-6 col-12 d-flex">
						<div class="card bg-secondary sale-widget flex-fill">
							<div class="card-body d-flex align-items-center">
								...
								<div class="ms-2">
									<p class="text-white mb-1">Total Confirmed Orders</p>
									<div class="d-inline-flex align-items-center flex-wrap gap-2">
										<h4 class="text-white">{{ $displayCurrency->symbol }}{{ number_format($totalCompletedOrders, 2) }}</h4>
					...
					<div class="col-xl-3 col-sm-6 col-12 d-flex">
						<div class="card bg-teal sale-widget flex-fill">
							<div class="card-body d-flex align-items-center">
								...
								<div class="ms-2">
									<p class="text-white mb-1">Total Pending Orders</p>
									<div class="d-inline-flex align-items-center flex-wrap gap-2">
										<h4 class="text-white">{{ $displayCurrency->symbol }}{{ number_format($totalPendingOrders, 2) }}</h4>
					...
					<div class="col-xl-3 col-sm-6 col-12 d-flex">
						<div class="card bg-info sale-widget flex-fill">
							<div class="card-body d-flex align-items-center">
								...
								<div class="ms-2">
									<p class="text-white mb-1">Today Total Purchase</p>
									<div class="d-inline-flex align-items-center flex-wrap gap-2">
										<h4 class="text-white">{{ $displayCurrency->symbol }}{{ number_format($todaytotalsale, 2) }}</h4>
...
<a href="{{ route('admin.product_orders.pending_product') }}" class="text-decoration-underline fs-13 fw-medium">View All</a>
</div>
        </div>
    </div>
</div>
...
<div class="d-flex align-items-center justify-content-between">
<a href="{{ route('admin.product_orders.index') }}" class="text-decoration-underline fs-13 fw-medium">View All</a>
</div>
        </div>
    </div>
</div>
...
<div class="col-xl-3 col-sm-6 col-12 d-flex">
    <div class="card revenue-widget flex-fill">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-3 pb-3 border-bottom">
                <div>
                    <h4 class="mb-1">{{ number_format($totalCustomers) }}</h4>
                    <p>Today Order</p>
                </div>
	...
	<div class="row">
					<div class="col-xl-3 col-sm-6 col-12 d-flex">
						<div class="card bg-primary sale-widget flex-fill">
							<div class="card-body d-flex align-items-center">
								<span class="sale-icon bg-white text-primary">
								<i class="fa-solid fa-bag-shopping fs-24"></i>
								</span>
								<div class="ms-2">
									<p class="text-white mb-1">Add New Product</p>
									<div class="d-inline-flex align-items-center flex-wrap gap-2">
 								 	<span class="badge badge-soft-primary"><a href="{{ route('admin.products.create') }}" class="text-decoration-underline fs-13 fw-medium" style="text-decoration: none;">Add Product</a></span>  
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-xl-3 col-sm-6 col-12 d-flex">
						<div class="card bg-secondary sale-widget flex-fill">
							<div class="card-body d-flex align-items-center">
								<span class="sale-icon bg-white text-secondary">
							<i class="fa-solid fa-upload fs-24"></i>
								</span>
								<div class="ms-2">
									<p class="text-white mb-1">Import Product CSV</p>
									<div class="d-inline-flex align-items-center flex-wrap gap-2">
 								 	<span class="badge badge-soft-primary"><a href="{{ route('admin.products.import') }}" class="text-decoration-underline fs-13 fw-medium" style="text-decoration: none;">Upload CSV</a></span>  
										<!---<span class="badge badge-soft-danger"><i class="ti ti-arrow-down me-1"></i>-22%</span>-->
									</div>
								</div>
							</div>
					...
					<div class="col-xl-3 col-sm-6 col-12 d-flex">
						<div class="card bg-teal sale-widget flex-fill">
							<div class="card-body d-flex align-items-center">
								...
								<div class="ms-2">
									<p class="text-white mb-1">Product Category</p>
								<div class="d-inline-flex align-items-center flex-wrap gap-2">
 								 	<span class="badge badge-soft-primary"><a href="{{ route('admin.product_categories.index') }}" class="text-decoration-underline fs-13 fw-medium" style="text-decoration: none;">Create Category</a></span>  
										<!---<span class="badge badge-soft-danger"><i class="ti ti-arrow-down me-1"></i>-22%</span>-->
									</div>
								</div>
							</div>
					...
					<div class="col-xl-3 col-sm-6 col-12 d-flex">
						<div class="card bg-info sale-widget flex-fill">
							<div class="card-body d-flex align-items-center">
								<span class="sale-icon bg-white text-info">
							<i class="fa-solid fa-drum-steelpan fs-24"></i>
								</span>
								<div class="ms-2">
									<p class="text-white mb-1">Product Brand</p>
						<div class="d-inline-flex align-items-center flex-wrap gap-2">
 								 	<span class="badge badge-soft-primary"><a href="{{ route('admin.brands.index') }}" class="text-decoration-underline fs-13 fw-medium" style="text-decoration: none;">Create Brand</a></span>  
										<!---<span class="badge badge-soft-danger"><i class="ti ti-arrow-down me-1"></i>-22%</span>-->
									</div>
								</div>
							</div>
...
@foreach($recentSales as $order)
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="d-flex align-items-center">
                <a href="javascript:void(0);" class="avatar avatar-lg">
                    ...
                    <img src="{{ asset($item->product->featured_image) }}" alt="img">
                </a>
                <div class="ms-2">
    ...
    @endforelse
            ...
            <div class="text-end">
                ...
                <span class="badge 
                    @if($order->status === 'processing') bg-purple 
