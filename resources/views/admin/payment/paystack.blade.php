 ...
 <div class="page-header">
						<div class="add-item d-flex">
							<div class="page-title">
								<h4 class="fw-bold">Paystack Setting</h4>
								<h6>Manage your Paystack</h6>
							</div>
						</div>
					   <!---
						<div class="page-btn">
...
<form method="POST" action="{{ route('admin.paystack.update') }}">
    @csrf
    @method('PUT')
    <div class="row">
<div class="col-md-12">
  <div class="mb-3">
    ...
    <input class="form-control"  type="text" name="public_key" value="{{ $paystackdata->public_key ?? '' }}">
</div></div>
<div class="col-md-12">
  <div class="mb-3">
    <label>Paystack Secret Key</label>
    <input class="form-control"  type="text" name="secret_key" value="{{ $paystackdata->secret_key ?? '' }}">
</div></div>
<div class="col-md-12">
  <div class="mb-3">
    <label>Merchant Email</label>
    <input class="form-control"  type="email" name="merchant_email" value="{{ $paystackdata->merchant_email ?? '' }}">
</div></div>
 
<div class="col-md-12">
  <div class="mb-3">
   <input type="checkbox" name="status" value="1" class="form-check-input" {{ $paystackdata->status ? 'checked' : '' }}>
        <label class="form-check-label">Enable Paystack</label>
</div></div>
